...
namespace AppTest.Controllers
{
    ...
    public class CandidatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nom,prenom,mail")] Candidat candidat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Id,nom,prenom,mail")] Candidat candidat)
        {
            if (id != candidat.Id)
            {
                return NotFound();
